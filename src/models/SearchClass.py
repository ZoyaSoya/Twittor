from src.models.MessangeClass import Messages
from src.models.UserClass import Users
...
class MessageParams:
    ...
    def convert(mess):
        return Messages(id=mess['_id'],
                        ...
                        AcceptedAnswerId=mess['_source'].get(
                            'AcceptedAnswerId', "None"),
                        CreationDate=mess['_source'].get(
                            'CreationDate', "None"),
                        ...
                        LastActivityDate=mess['_source'].get(
                        ...
                        ContentLicense=mess['_source'].get(
                            'ContentLicense', 0),
                        LastEditorUserId=mess['_source'].get(
